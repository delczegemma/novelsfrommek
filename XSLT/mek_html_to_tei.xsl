                    ...
                    <titleStmt>
                        <title>
                            ...
                            <xsl:if test="mek2/dc_title/subtitle != ''">
                                <xsl:text> : </xsl:text>
                                <xsl:value-of select="mek2/dc_title/subtitle"/>
                            </xsl:if> : ELTeC edition
                        </title>
                        <!--<title type="sub">
                            ...
                            <bibl type="digitalSource">
                                ...
                                <date>
                                    <xsl:for-each select="mek2/dc_date">
                                        <xsl:if test="contains(./mekevent, 'MEK-be való felvétel időpontja')">
                               ...
                               <!-- <title type="sub">
                                ...
                                <ref>
                                    <xsl:attribute name="target">
                                        <xsl:value-of
                                            select="normalize-space(mek2/dc_identifier/URL)"/>
                                    </xsl:attribute>
                                </ref>
                                    ...
                                    <bibl type="PrintSource">
                                        <xsl:choose>
                                            <xsl:when test="contains(mek2/PrintedSource, ';OSZK:')">
                                                <xsl:value-of select="normalize-space(substring-before(mek2/PrintedSource, ';OSZK:'))"/>
                                                <ref>
                                                    <xsl:attribute name="target">
                                                        <xsl:value-of select="normalize-space(substring-after(mek2/PrintedSource, 'OSZK:'))"/>
                                                    </xsl:attribute>
                                                </ref>
                                            </xsl:when>
                                            <xsl:otherwise><xsl:value-of select="normalize-space(mek2/PrintedSource)"/></xsl:otherwise>
